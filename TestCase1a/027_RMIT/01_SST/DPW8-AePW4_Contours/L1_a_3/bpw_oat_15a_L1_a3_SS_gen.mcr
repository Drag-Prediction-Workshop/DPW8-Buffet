...
#
$!ReadDataSet  '"D:\ANSYS Work\Buffet Workshop\Distributions\Full wall\bpw_oat15a_L1_a3_SS_wall.dat.h5.plt" '
  ReadDataOption = New
  ResetStyle = No
  VarLoadMode = ByName
  AssignStrandIDs = Yes
...
$!VarSet |ALPHA|    = '3.0'  # Angle-of-Attack
$!VarSet |CL|       = '0.896'  # Lift Coefficient
$!VarSet |CD|       = '0.0326' # Drag Coefficient
$!VarSet |CMy|      = '0.118' # Pitching Moment Coefficient
