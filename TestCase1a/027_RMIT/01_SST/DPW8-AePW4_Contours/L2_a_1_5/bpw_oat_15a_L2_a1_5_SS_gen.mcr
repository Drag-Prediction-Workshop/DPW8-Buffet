...
#
$!ReadDataSet  '"D:\ANSYS Work\Buffet Workshop\Second Run\L2\Data\Wall\bpw_oat15a_L2_a1_5_SS_wall.plt" '
  ReadDataOption = New
  ResetStyle = No
  VarLoadMode = ByName
  AssignStrandIDs = Yes
...
$!VarSet |CL|       = '0.754'  # Lift Coefficient
$!VarSet |CD|       = '0.0132' # Drag Coefficient
$!VarSet |CMy|      = '0.122' # Pitching Moment Coefficient
