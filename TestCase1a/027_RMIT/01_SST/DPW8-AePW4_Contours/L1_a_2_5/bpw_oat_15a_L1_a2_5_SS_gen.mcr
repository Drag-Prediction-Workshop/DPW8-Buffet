...
#
$!ReadDataSet  '"D:\ANSYS Work\Buffet Workshop\Distributions\Full wall\bpw_oat15a_L1_a2_5_SS_wall.dat.h5.plt" '
  ReadDataOption = New
  ResetStyle = No
  VarLoadMode = ByName
  AssignStrandIDs = Yes
...
$!VarSet |ALPHA|    = '2.5'  # Angle-of-Attack
$!VarSet |CL|       = '0.881'  # Lift Coefficient
$!VarSet |CD|       = '0.0255' # Drag Coefficient
