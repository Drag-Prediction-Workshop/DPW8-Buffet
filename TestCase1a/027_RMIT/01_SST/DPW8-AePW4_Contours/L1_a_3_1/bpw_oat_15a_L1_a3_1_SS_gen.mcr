...
#
$!ReadDataSet  '"D:\ANSYS Work\Buffet Workshop\Distributions\Full wall\bpw_oat15a_L1_a3_1_SS_wall.dat.h5.plt" '
  ReadDataOption = New
  ResetStyle = No
  VarLoadMode = ByName
  AssignStrandIDs = Yes
...
#
$!VarSet |ParticipantID|        = '027.1'  # Participant ID for this data set
...
$!VarSet |ALPHA|    = '3.1'  # Angle-of-Attack
$!VarSet |CL|       = '0.896'  # Lift Coefficient
$!VarSet |CD|       = '0.0340' # Drag Coefficient
$!VarSet |CMy|      = '0.117' # Pitching Moment Coefficient
