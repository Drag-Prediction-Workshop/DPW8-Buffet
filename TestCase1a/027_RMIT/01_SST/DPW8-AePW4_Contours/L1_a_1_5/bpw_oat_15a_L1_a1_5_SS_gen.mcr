...
#
$!ReadDataSet  '"D:\ANSYS Work\Buffet Workshop\Distributions\Full wall\bpw_oat15a_L1_a1_5_SS_wall.dat.h5.plt" '
  ReadDataOption = New
  ResetStyle = No
  VarLoadMode = ByName
  AssignStrandIDs = Yes
...
$!VarSet |ALPHA|    = '1.5'  # Angle-of-Attack
$!VarSet |CL|       = '0.756'  # Lift Coefficient
$!VarSet |CD|       = '0.0113' # Drag Coefficient
$!VarSet |CMy|      = '0.123' # Pitching Moment Coefficient
