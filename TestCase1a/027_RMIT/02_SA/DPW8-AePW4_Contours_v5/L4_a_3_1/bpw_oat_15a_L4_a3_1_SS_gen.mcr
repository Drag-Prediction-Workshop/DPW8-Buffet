...
#
$!ReadDataSet  '"D:\ANSYS Work\Buffet Workshop\RANS SA\L4\Data\Wall\bpw_oat15a_L4_a3_1_SS_wall.plt" '
  ReadDataOption = New
  ResetStyle = No
  VarLoadMode = ByName
  AssignStrandIDs = Yes
...
$!VarSet |MACH|     = '0.73'   # Mach num ber
$!VarSet |ALPHA|    = '3.1'  # Angle-of-Attack
$!VarSet |CL|       = '0.967'  # Lift Coefficient
$!VarSet |CD|       = '0.0395' # Drag Coefficient
$!VarSet |CMy|      = '0.134' # Pitching Moment Coefficient
